...
class ConfigTests(unittest.TestCase):
    ...
    @patch("project_initializer.config.input", return_value="interactive-group")
    def test_interactive_prompt_for_gitlab_namespace_uses_entered_value(
        self,
        mock_input: object,
    ) -> None:
        with tempfile.TemporaryDirectory() as temp_dir:
        ...
        self.assertEqual(config.gitlab.namespace, "interactive-group")
    ...
    def test_interactive_prompt_for_gitlab_namespace_defaults_to_none_when_empty(
        self,
        mock_input: object,
    ) -> None:
        with tempfile.TemporaryDirectory() as temp_dir:
